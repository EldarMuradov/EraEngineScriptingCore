...
namespace EngineLibrary.Extensions
{
    public static class TaskExtensions
    {
        ...
        public static async Task<TResult> Fallback<TResult>(this Task<TResult> task, TResult fallback)
        {
            try
            {
        ...
        public static async Task<TResult> Retry<TResult>(this Func<Task<TResult>> factory, int iterations, TimeSpan delay)
        {
